# 🏥 **Hospital Management System - Spring Boot Backend Services**
...
1. **Clone the repository**:
   ```sh
   git clone https://github.com/mukundjha-mj/HospitalManagementSystem-SpringBoot-Backend-Services.git
